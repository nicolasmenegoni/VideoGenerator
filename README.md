...
5. Na aba **Video**, copie um link do Pexels e clique em **Colar link** ao lado da frase para aplicar direto da área de transferência; use **Editar** se quiser ajustar manualmente, ou deixe vazio para busca automática.
