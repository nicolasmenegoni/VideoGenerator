...
5. Na aba **Video**, copie um link do Pexels ou uma imagem e clique em **Colar link** ao lado da frase para aplicar direto da área de transferência; quando for imagem, ela aparece imediatamente no preview e será usada na cena. Para links, o app carrega o preview pequeno da foto/vídeo em segundo plano quando consegue resolver a miniatura, sem travar a lista. Use **Editar** se quiser ajustar manualmente, ou deixe vazio para busca automática.
