...
Para usar **Gerar imagem**, execute o Forge WebUI com a API habilitada (por exemplo, com `--api`) antes de clicar no botão dentro do app. Se preferir, preencha **Comando para iniciar Forge** na aba **APIs** com o caminho do `webui-user.bat`, da pasta do Forge ou com um comando completo; quando o Forge estiver fechado, o app tentará abri-lo automaticamente e aguardará a API responder.
